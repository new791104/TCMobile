...
public class SelectHistoPagerAdapter extends FragmentPagerAdapter {
    private Context context;

    public SelectHistoPagerAdapter(FragmentManager fm, Context nContext) {
        super(fm);
        context = nContext;
    }
...
//                break;
    ...
    public int getCount() {
        // Show total pages.
        return context.getResources().getInteger(R.integer.main_page_size);
    }
